...
Introducing Arrow Functions | 19
Remove the function keyword before the function arguments. Add an arrow
between the function arguments and function body.
